...
app.post("/add", async (req, res) => {
  ...
  try { 
    ...
    // == THIS ALSO WORKS: NOTE single quotation for LIKE argument ! ==
    // const sql = `SELECT country_code from countries WHERE LOWER(country_name) LIKE '%${country_name}%'`;
    // console.log(sql); 
